...
insert into catch_cats values (default, 'Brian', 20, 'Avid guitar player and java development wizard', 'Short', 24, 'Java Development Instructor', 'Brian likes to do Bee cosplay and is a Bob Seger fanatic', 'Grey',false, 'image(1).png',false, 3, 4,3,4,3);
insert into catch_cats values (default, 'Rachelle', 14, 'The Lady of Perpetual Breaks', 'Short', 2, 'Assistant Java Instructor', 'She loves her students, her kittens, and her dog Turkey', 'Grey/White', false, 'image(2).png',false, 2, 4,2,4,2);
insert into catch_cats values (default, 'Chloe', 2, 'Drawing and sleeping', 'Short', 3, 'Ice Cream Scooper', 'Playing minecraft, draw, and thats about it', 'White/Brown', false, 'image(3).png',false, 2, 3,2,4,1);
insert into catch_cats values (default, 'Olivia', 3, 'Photgraphy, website development ', 'Short', 7, 'Optician', 'Likes to go to South Carolina, drives fast and take pictures', 'Grey', false, 'image(4).png',false, 2, 4,5,3,2);
